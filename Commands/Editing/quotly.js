...
module.exports = async (context) => {
  try {
    ...
    const baseImage = await Jimp.read('https://files.catbox.moe/ktqas9.jpg');
    const avatarImage = await Jimp.read('https://files.catbox.moe/i0s7d2.jpg');
    ...
    baseImage.print(
      ...
      70,
      10,
      { text: 'EMINEM-MD', alignmentX: Jimp.HORIZONTAL_ALIGN_LEFT },
      200
    );
